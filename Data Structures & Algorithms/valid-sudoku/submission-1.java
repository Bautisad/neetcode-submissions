    ...
    public boolean isValidSudoku(char[][] board) {
        ...
        for (int row = 0; row < 9; row++) {
            for (int col = 0; col < 9; col++) {
                ...
                //determines where the square is located
                String squareKey = (row / 3) + "," + (col / 3);

                //checks if board contains the same keys in the row, col, or 3x3 board
                //returns false if it does contain.
                //k -> HashSet just means that the new hashset is named k.
                ...
                //adds these to the HashMaps from the current board.
